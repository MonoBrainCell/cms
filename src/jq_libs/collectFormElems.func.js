...
function collectFormElems(formName){
	...
	var textValues=$("form[name="+formName+"] input[type=text], form[name="+formName+"] input[type=password], form[name="+formName+"] input[type=submit], form[name="+formName+"] input[type=reset], form[name="+formName+"] textarea");
