...
$array=array(
	...
	"content"=>array(
		"name"=>"App_settings_redactAccessType",
		"parent"=>"none",
		"type"=>"involvement",
		"content"=>"none",
		"headerTags"=>"{include:functional_departments/settings/settings/redactAccessType_headers.fbd.tpl}"
	)
);
?>