...
$(document).ready(function(){
	...
	$("input[type=text]:not('[name=quantity]'),input[type=password]").textFieldsManager(fieldSettings1);
	$("body").on('click',"#recharge_request",function(){
		$("#ajax_close_button").trigger("click");
		
		var datas=collectFormElems("gen_password");
		datas.phpFileInc=$("form[name=gen_password]").attr("action");
