...
$array=array(
	...
	"content"=>array(
		...
		"parent"=>"none",
		"type"=>"embed",
		"content"=>"{include:functional_departments/settings/dummyes/filesManager.fbd.tpl}",
		"headerTags"=>"{include:functional_departments/settings/settings/filesManager_headers.fbd.tpl}"
	)
);
?>