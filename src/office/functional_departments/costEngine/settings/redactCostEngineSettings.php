...
$array=array(
	"title"=>array(
		...
		"parent"=>"none",
		"type"=>"embed",
		"content"=>"Редактирование формы on-line калькулятора",
		"headerTags"=>"none"
	),
	"base_tag"=>array(
	...
	"content"=>array(
		"name"=>"App_costEngine_developer",
		"parent"=>"none",
		"type"=>"involvement",
		"content"=>"none",
		"headerTags"=>"{include:functional_departments/costEngine/settings/redactCostEngine_headers.fbd.tpl}"
	)
);
?>