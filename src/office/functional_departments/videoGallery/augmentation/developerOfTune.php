...
class App_videoGallery_developerOfTune extends ErrorsManager{
	const VIDEO_INSERT_TPL_FILE="../functional/videoGallery/dummyes/videoGalleryTpls.fbd.tpl";
	const TUNE_CONTEINER_TPL_PATH="functional_departments/videoGallery/dummyes/tuneVideoGallery_conteiner.fbd.tpl";
	private $htmlContent;
	...
	private function replaceKeywords($arrayElem,$template){
		...
		$totalString=str_replace("{VIDEO_CODE}",$entityConvert->maskEngine($arrayElem[1]),$totalString);
		return $totalString;
	}
