...
$(document).ready(function(){
	...
	fieldSettings2.symbolsW.symbsToSearch=/[а-яА-Яa-zA-Z\,\!\+\-\_\~\`\@\#\$\%\^\&\*\(\)\=\[\]\{\}\:\;\'\"\<\>\?\/]/;
	...
	$("input[type=text][name=video_name]").textFieldsManager(fieldSettings1);
	$("input[type=text][name=video_width],input[type=text][name=video_height]").textFieldsManager(fieldSettings2);
});
</script>
