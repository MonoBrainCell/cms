...
.variable_name {color:#009; font-weight: 700;}
	...
	<h1>Редактирование формы обратной связи</h1>
	<p style="color: #b00;">Работа с кодом обратной связи (изменение) предполагает наличие навыков и знаний в области html-вёрстки.</p>
	...
	<form name="feedback_redact" action="functional_departments/feedback/executors/contentSave.php" method="post" target="ajax">
	...
	<h2>Html-код формы обратной связи (для отображения)</h2>
	<div class="form_elem">
		<span class="block_with_advice" style="margin-right:0;">
			<span class="view_advice" title="Пояснение"></span>
			<span class="advice">Содержание данного поля будет использовано как исходный html-код формы обратной связи.
			</span>
		</span>
