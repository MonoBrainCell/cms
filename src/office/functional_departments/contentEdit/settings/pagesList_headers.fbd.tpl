...
$(document).ready(function(){
	$('.remove_datas').click(function(){
		...
		var deleteAgree=confirm("Вы уверены, что хотите удалить страницу '"+pageName+"'? Весь текстовый контент используемый в ней будет удалён безвозратно.");
		if (deleteAgree===true){
			...
			datas.phpFileInc="functional_departments/contentEdit/executors/deletePage.php";
