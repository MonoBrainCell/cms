...
class saveImagesGalleryTune{
	...
	public function __construct(){
		...
		$array=array("browser_headers","html_separate_gallery","html_built-in_gallery");
		$totalArray=array();
...
$varObj=new saveImagesGalleryTune();
?>
