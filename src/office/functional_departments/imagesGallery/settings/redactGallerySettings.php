...
$array=array(
	"title"=>array(
		...
		"parent"=>"none",
		"type"=>"embed",
		"content"=>"Редактирование галереи изображений",
		"headerTags"=>"none"
	),
	"base_tag"=>array(
	...
	"content"=>array(
		"name"=>"App_imagesGallery_developer",
		"parent"=>"none",
		"type"=>"involvement",
		"content"=>"none",
		"headerTags"=>"{include:functional_departments/imagesGallery/settings/redactGallery_headers.fbd.tpl}"
	)
);
?>