...
$(document).ready(function(){
	$('.remove_datas').click(function(){
		...
		var deleteAgree=confirm("Вы уверены, что хотите удалить этот виджет '"+pageName+"'?");
		if (deleteAgree===true){
			var pageNumber=$(this).attr('id');
			pageNumber=pageNumber.replace(/widget_number_/,"");
			var datas={};
			datas.pageNum=pageNumber;
			datas.submitBut='Agree to delete';
			datas.phpFileInc="functional_departments/imagesGallery/executors/deletePage.php";
