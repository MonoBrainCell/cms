...
class checkFilesOnSite{
	...
	public function __construct(){
		...
		if (isset($markerOfExisting)===true){
			...
			echo "<span class='error_class'>Некоторые файлы уже имеются в указанных Вами директориях:<br><br>".implode("<br><br>",$varArr).".<br><br> Переименуйте файлы и повторите попытку загрузки.</span>\r\n".self::NAVIGATE_BUTTONS;
			exit;
		}
		else {
