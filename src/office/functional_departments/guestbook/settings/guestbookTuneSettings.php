...
$array=array(
	"title"=>array(
		...
		"parent"=>"none",
		"type"=>"embed",
		"content"=>"Настройка гостевой книги",
		"headerTags"=>"none"
	),
	"base_tag"=>array(
	...
	"content"=>array(
		"name"=>"App_guestbook_developerOfTune",
		"parent"=>"none",
		"type"=>"involvement",
		"content"=>"none",
		"headerTags"=>"{include:functional_departments/guestbook/settings/guestbookTune_headers.fbd.tpl}"
	)
);
?>