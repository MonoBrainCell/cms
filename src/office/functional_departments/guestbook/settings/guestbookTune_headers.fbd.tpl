...
$(document).ready(function(){
	...
	$("form[name=tune_guestbook]").submit(function(){
			return false;	
		});
		$("form[name=tune_guestbook] input[type=submit]").click(function(){
			var confirmAction=confirm("Хотите сохранить изменения?");
			if (confirmAction===true){
				var datas=collectFormElems("tune_guestbook");
		...
		$("#view_available_css").click(function(){
			var datas={};
			datas['phpFileInc']="functional_departments/guestbook/executors/filesViewer.php";
			datas.direction="css";
		...
		$("#view_available_php").click(function(){
			var datas={};
			datas['phpFileInc']="functional_departments/guestbook/executors/filesViewer.php";
			datas.direction="php";
			var messageWindowProps={};
			messageWindowProps.startActMsg="Производится поиск доступных php-файлов . . .";
			messageWindowProps.id="viewer_images_window";
			messageWindowProps.overburdenId="ajax_overburden";
			messageWindowProps.closeButId="ajax_close_button";
			messageWindowProps.errorMsg="Простите, произошла ошибка во время поиска. Обновите страницу в браузере и повторите попытку.";
...
<style type="text/css">
#view_available_css,#view_available_js,#view_available_php{
...
#view_available_php {margin-top: 260px;}
