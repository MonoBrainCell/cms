...
$array=array(
	"title"=>array(
		...
		"parent"=>"none",
		"type"=>"embed",
		"content"=>"Редактор записи в гостевой книге",
		"headerTags"=>"none"
	),
	"base_tag"=>array(
	...
	"content"=>array(
		"name"=>"App_guestbook_developer",
		"parent"=>"none",
		"type"=>"involvement",
		"content"=>"none",
		"headerTags"=>"{include:functional_departments/guestbook/settings/redactRecord_headers.fbd.tpl}"
	)
);
?>