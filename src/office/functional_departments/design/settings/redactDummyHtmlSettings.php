...
$array=array(
	"title"=>array(
		...
		"parent"=>"none",
		"type"=>"embed",
		"content"=>"Редактирование html-кода активного шаблона",
		"headerTags"=>"none"
	),
	"base_tag"=>array(
	...
	"content"=>array(
		"name"=>"App_design_htmlDeveloper",
		"parent"=>"none",
		"type"=>"involvement",
		"content"=>"none",
		"headerTags"=>"{include:functional_departments/design/settings/redactDummyHtml_headers.fbd.tpl}"
	)
);
?>