...
if (file_exists("functional_departments/ad/dummyes/viewFlashesList_mainContent.fbd.tpl")===true)
	...
	$tpl1="";
if (file_exists("functional_departments/ad/dummyes/viewPagesList_element.fbd.tpl")===true)
	$tpl2=file_get_contents("functional_departments/ad/dummyes/viewPagesList_element.fbd.tpl");
else
	$tpl2="";

$varObject=new Shr__listOfPages($tpl1,$tpl2);
echo $varObject->pagesListHTML;
exit;
?>