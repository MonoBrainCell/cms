...
$(document).ready(function(){
	$('.remove_datas').click(function(){
		...
		var deleteAgree=confirm("Вы уверены, что хотите удалить этот баннер '"+pageName+"'?");
		if (deleteAgree===true){
			var pageNumber=$(this).attr('id');
			pageNumber=pageNumber.replace(/banner_number_/,"");
			var datas={};
			datas.pageNum=pageNumber;
			datas.submitBut='Agree to delete';
			datas.phpFileInc="functional_departments/ad/executors/deleteBanner.php";
