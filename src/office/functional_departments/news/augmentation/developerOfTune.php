...
class App_news_developerOfTune extends ErrorsManager{
	...
	const TUNE_ELEM_TPL_PATH="functional_departments/news/dummyes/tuneNews_elem.fbd.tpl";
	const TUNE_CONTEINER_TPL_PATH="functional_departments/news/dummyes/tuneNews_conteiner.fbd.tpl";
	private $htmlContent;
	...
	public function __construct(){
		...
		if ($tOT=="block"){
			$formStructure=array(
				...
				array(
					"type"=>"singl",
					"fieldName"=>"news_block_wrapper",
					"fieldDesc"=>"Шаблон оболочки списка новостей",
					"idInTpl"=>1
				),
				array(
					"type"=>"singl",
					"fieldName"=>"news_summary_assembly",
					"fieldDesc"=>"Шаблон отображения краткого содержания новости",
					"idInTpl"=>2
				),
				array(
					"type"=>"singl",
					"fieldName"=>"anchor_to_full_news",
					"fieldDesc"=>"Шаблон отображения ссылки на полное содержание новости",
					"idInTpl"=>3
				),
				array(
					"type"=>"singl",
					"fieldName"=>"numeral_navigation_wrapper",
					"fieldDesc"=>"Шаблон оболочки навигации по новостным страницам",
					"idInTpl"=>4
				),
				array(
					"type"=>"singl",
					"fieldName"=>"numeral_navigation_anchor",
					"fieldDesc"=>"Шаблон ссылки навигации по новостным страницам",
					"idInTpl"=>5
				),
				array(
					"type"=>"singl",
					"fieldName"=>"numeral_navigation_deadlock",
					"fieldDesc"=>"Шаблон указателя текущей страницы",
					"idInTpl"=>6
				)
			);
			...
			$formStructure=array(
				...
				array(
					"type"=>"singl",
					"fieldName"=>"news_item_assembly",
					"fieldDesc"=>"Шаблон отображения новости",
					"idInTpl"=>1
				)
			);
		}
