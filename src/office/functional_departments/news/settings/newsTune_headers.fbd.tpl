...
$(document).ready(function(){
	...
	$("form[name=tune_news]").submit(function(){
			return false;	
		});
		$("form[name=tune_news] input[type=submit]").click(function(){
			var confirmAction=confirm("Хотите сохранить изменения?");
			if (confirmAction===true){
				var datas=collectFormElems("tune_news");
		...
		$("#view_available_css").click(function(){
			var datas={};
			datas['phpFileInc']="functional_departments/news/executors/filesViewer.php";
			datas.direction="css";
